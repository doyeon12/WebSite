const idioms = [
    ...
    { term: "불치하문(不恥下問)", meaning: "아랫사람에게 배우는 것을 부끄러워하지 않다", hint: "누군가에게 배우는 것에 대한 의미입니다." },
    { term: "심심상인(心心相印)", meaning: "마음과 마음이 서로 통하다", hint: "사람 간의 깊은 이해를 나타냅니다." },
    { term: "동분서주(東奔西走)", meaning: "동쪽으로 뛰고 서쪽으로 달리다", hint: "여러 곳으로 바쁘게 다니는 상황을 설명합니다." }
];
